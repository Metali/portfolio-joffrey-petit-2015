app.navbarAnimation = {
    ...
    show: function() {
        ...
        TweenMax.fromTo("#page-content", 1, {opacity:1, ease: Power4.easeInOut}, {opacity:0.2,ease: Power4.easeInOut})
    ...
    hide: function() {
        ...
        setTimeout(function() {
            ...
            TweenMax.fromTo("#page-content", 1, {opacity:0.2,ease: Power4.easeInOut},{opacity:1, ease: Power4.easeInOut})
